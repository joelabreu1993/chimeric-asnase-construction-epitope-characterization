...
cmd.load("Variante1322_22412_monomer.pdb")

# --- Alinhamento ---
cmd.align("6v2a_monomer", "Variante1322_22412_monomer")
...
cmd.select("pocket_model", "Variante1322_22412_monomer within 3.5 of pocket_6v2a")
...
if not atoms:
    ...
    cmd.select("pocket_residues", "(byres (Variante1322_22412_monomer within 8 of centro_pocket) and polymer.protein)")

    # --- Mostrar proteínas como cartoon e colorir, excluindo o ligante ---
    cmd.show("cartoon", "Variante1322_22412_monomer")
    cmd.color("slate", "Variante1322_22412_monomer and not lig")
    ...
    # --- Salvar informações no arquivo centroid.txt ---
    residues = []
    ...
    with open("centroid.txt", "w") as f:
        f.write(f"Coordenadas X, Y e Z do centroide:\n")
        f.write(f"{x:10.3f} {y:10.3f} {z:10.3f}\n\n")
        f.write(f"Há {n_residues} aminoácidos em um raio de 10 Å do centroide:\n\n")
